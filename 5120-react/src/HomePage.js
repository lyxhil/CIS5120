...
const allFriends = [
    ...
    { name: 'Mrs Smith', message: 'Yes, tomorrow 3pm works', image: mrsSmithImage, groupColor: '#FFB434' },
    { name: 'Mr Drew', message: 'How has school been?', image: mrDrewImage, groupColor: 'FFB434' },
